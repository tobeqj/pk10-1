...
public class Fm4 extends BaseFm {
    ...
    private com.laowopcdandan28.view.TagGroup m_tag1;

    @ViewInject(R.id.tag2)
    private com.laowopcdandan28.view.TagGroup m_tag2;

    @ViewInject(R.id.tag3)
    private com.laowopcdandan28.view.TagGroup m_tag3;
